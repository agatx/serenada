...
// Join
export const AUDIO_COORDINATOR_TIMEOUT_MS = 10000;
...
export const OUTBOUND_MEDIA_WATCHDOG_INTERVAL_MS = 5000;
export const OUTBOUND_MEDIA_STALL_SAMPLES = 2;
export const OUTBOUND_MEDIA_RECOVERY_COOLDOWN_MS = 30000;
