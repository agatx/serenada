    ...
    companion object {
        ...
        fun mergeRealtimeStats(stats: List<RealtimeCallStats>): RealtimeCallStats? {
            ...
            return RealtimeCallStats(
                ...
                audioRxCodec = joinCodecMimeTypes(stats.mapNotNull { it.audioRxCodec }),
                audioTxCodec = joinCodecMimeTypes(stats.mapNotNull { it.audioTxCodec }),
                ...
                videoRxCodec = joinCodecMimeTypes(stats.mapNotNull { it.videoRxCodec }),
                videoTxCodec = joinCodecMimeTypes(stats.mapNotNull { it.videoTxCodec }),
