...
public struct CallScene: Decodable {
    public let viewportWidth: CGFloat
    public let viewportHeight: CGFloat
    public let safeAreaInsets: LayoutInsets
    public let participants: [SceneParticipant]
    public let localParticipantId: String
    public let activeSpeakerId: String?
    public let pinnedParticipantId: String?
    public let contentSource: ContentSource?
    public let userPrefs: UserLayoutPrefs

    public init(viewportWidth: CGFloat, viewportHeight: CGFloat, safeAreaInsets: LayoutInsets,
...
public struct SceneParticipant: Decodable {
    public let id: String
    public let role: ParticipantRole
    public let videoEnabled: Bool
    public let videoAspectRatio: CGFloat?

    public init(id: String, role: ParticipantRole, videoEnabled: Bool, videoAspectRatio: CGFloat?) {
        self.id = id
        self.role = role
...
public struct ContentSource: Decodable {
    public let type: ContentType
    public let ownerParticipantId: String
    public let aspectRatio: CGFloat?

    public init(type: ContentType, ownerParticipantId: String, aspectRatio: CGFloat?) {
        self.type = type
...
public struct UserLayoutPrefs: Decodable {
    public var swappedLocalAndRemote: Bool = false
    public var dominantFit: FitMode = .cover

    public init() {}

    public init(swappedLocalAndRemote: Bool = false, dominantFit: FitMode = .cover) {
        self.swappedLocalAndRemote = swappedLocalAndRemote
        self.dominantFit = dominantFit
    }
}

public struct LayoutInsets: Decodable {
...
public struct LayoutResult {
    ...
    public let localPip: PipLayout?

    public init(mode: LayoutMode, tiles: [TileLayout], localPip: PipLayout?) {
        self.mode = mode
        self.tiles = tiles
        self.localPip = localPip
    }
}

public struct TileLayout {
    public let id: String
    public let type: OccupantType
    public let frame: LayoutRect
    public let fit: FitMode
    public let cornerRadius: CGFloat
    public let zOrder: Int

    public init(id: String, type: OccupantType, frame: LayoutRect, fit: FitMode, cornerRadius: CGFloat, zOrder: Int) {
        self.id = id
        self.type = type
        self.frame = frame
        self.fit = fit
...
public enum OccupantType: String, Codable {
    case participant
    case contentSource
}

public struct PipLayout {
    ...
    public init(participantId: String, frame: LayoutRect, fit: FitMode, cornerRadius: CGFloat, anchor: Anchor, zOrder: Int) {
...
public struct StageTileSpec {
    public let cid: String
    public let aspectRatio: CGFloat

    public init(cid: String, aspectRatio: CGFloat) {
        self.cid = cid
        self.aspectRatio = aspectRatio
    }
}

public struct StageTileLayout: Identifiable {
    public let cid: String
    public let width: CGFloat
    public let height: CGFloat
    ...
    public init(cid: String, width: CGFloat, height: CGFloat) {
        self.cid = cid
        self.width = width
        self.height = height
    }
...
public struct StageRowLayout: Identifiable {
    public let items: [StageTileLayout]
    public let index: Int

    public var id: Int { index }

    public init(items: [StageTileLayout], index: Int) {
        self.items = items
        self.index = index
    }
}
...
public func clampStageTileAspectRatio(_ ratio: CGFloat?) -> CGFloat {
...
public func computeStageLayout(
    tiles: [StageTileSpec],
...
public func computeLayout(scene: CallScene) -> LayoutResult {
