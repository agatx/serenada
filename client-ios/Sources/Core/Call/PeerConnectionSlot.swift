...
final class PeerConnectionSlot {
    ...
    var lastIceRestartAt: TimeInterval = 0
    var offerTimeoutTask: Task<Void, Never>?
    var iceRestartTask: Task<Void, Never>?
    var nonHostFallbackTask: Task<Void, Never>?
    ...
    func attachLocalTracks(audioTrack: AnyObject? = nil, videoTrack: AnyObject? = nil) {
#if canImport(WebRTC)
